...
class Settings(BaseSettings):
    ...
    DB_PORT: int = 5432
    DB_NAME: str = "it_service_pro"
    DB_USER: str = "itservice_user"
    DB_PASSWORD: str = "ChangeMe123!"
    DATABASE_URL: str = (
        "postgresql+psycopg2://itservice_user:ChangeMe123!@localhost:5432/it_service_pro"
    )
    ...
    # Aplicación
    APP_NAME: str = "IT Service Pro"
    APP_ENV: str = "development"
    DEBUG: bool = True
    API_V1_PREFIX: str = "/api/v1"

    # =========================================
    # ARCHIVOS SUBIDOS (fotos de tickets, documentos)
    # =========================================
