...
router = APIRouter(prefix="/appointments", tags=["Citas"], dependencies=[Depends(require_roles(
    RolesSistema.ADMINISTRADOR, RolesSistema.COORDINADOR, RolesSistema.TECNICO
))])
...
def estado(cita_id: uuid.UUID, datos: CitaCambiarEstadoRequest,
    ...
    elif rol == RolesSistema.COORDINADOR and datos.estado == EstadoCita.FINALIZADA:
