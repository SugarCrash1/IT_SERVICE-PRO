...
if TYPE_CHECKING:
    ...
    from app.models.itsp_foundation_model import ContactoEmpresa
...
class Usuario(Base, TimestampMixin):
    ...
    contacto_empresa_id: Mapped[uuid.UUID | None] = mapped_column(ForeignKey("contactos_empresa.id", ondelete="SET NULL"), nullable=True, unique=True, index=True)
    ...
    contacto_empresa: Mapped["ContactoEmpresa | None"] = relationship(foreign_keys=[contacto_empresa_id], uselist=False)
