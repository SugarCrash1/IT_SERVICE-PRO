...
def create_users(db: Session, roles: dict[str, Rol]) -> dict[str, Usuario]:
    data = [
        ...
        ("Valentina Rojas", "recepcion@salon.com", "Recepcion123*", RolesSistema.COORDINADOR, "999100002"),
        ("Sofía Reyes", "estilista@salon.com", "Estilista123*", RolesSistema.TECNICO, "999100003"),
    ]
    result = {}
